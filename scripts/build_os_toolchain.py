...
def build() -> None:
    ...
    with tempfile.TemporaryDirectory() as build_dir_raw:
        ...
        build_products_dir = Path(__file__).parent / "toolchain-build-products"
        ...
        if False:
            ...
            env = {"PATH": f'{(build_products_dir / "bin").as_posix()}:{os.environ["PATH"]}'}
        ...
        if True:
            ...
            # PT: Pause here and build newlib?
