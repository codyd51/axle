...
//#endif
	...
	printf( "liballoc: System memory allocated:     0x%08x bytes\n", l_allocated );
	printf( "liballoc: Memory in used (malloc'ed):  0x%08x bytes\n", l_inuse );
...
struct liballoc_major *allocate_new_page( unsigned int size )
{
	unsigned int st;
