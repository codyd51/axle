...
// #define AP_BOOTSTRAP_PARAM_OFFSET_LONG_MODE_IDT 0x200
...
// #define AP_BOOTSTRAP_PARAM_LONG_MODE_IDT (AP_BOOTSTRAP_DATA_PAGE + AP_BOOTSTRAP_PARAM_OFFSET_LONG_MODE_IDT)
