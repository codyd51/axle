...
void boot_info_read(axle_boot_info_t* bootloader_info) {
    ...
    boot_info->file_server_elf_start = bootloader_info->file_server_elf_base;
    boot_info->file_server_elf_size = bootloader_info->file_server_elf_size;
    boot_info->file_server_elf_end = bootloader_info->file_server_elf_base + bootloader_info->file_server_elf_size;
...
void boot_info_dump() {
    ...
    printf("File server image at [0x%08x to 0x%08x]. Size: 0x%x\n", info->file_server_elf_start, info->file_server_elf_end, info->file_server_elf_size);
