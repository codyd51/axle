...
int main(int argc, char** argv) {
	...
	text_box->size = size_make(800, 600);
	text_box->origin = point_make(0, 0);
	text_box->cursor_pos = text_box->origin;
	text_box->font_size = size_make(10, 10);
	text_box->font_padding = size_make(0, 2);

	draw_rect(window_layer, rect_make(point_zero(), size_make(800, 600)), color_blue(), THICKNESS_FILLED);
