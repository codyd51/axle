...
axle: boot.s linker.ld std.c kb.c kernel.c shell.c clock.c common.c ide.c enableA20.s descriptor_tables.h descriptor_tables.c gdt.s interrupt.s isr.c isr.h timer.h timer.c kheap.h kheap.c paging.h paging.c paging_util.s 
	$(AS) boot.s -o boot.o
	...
	$(CC) -T linker.ld -o axle.bin -ffreestanding -O2 -nostdlib boot.o checkA20.o enableA20.o kernel.o shell.o kb.o std.o clock.o common.o gdt.o interrupt.o descriptor_tables.o isr.o timer.o kheap.o paging.o paging_util.o -lgcc
