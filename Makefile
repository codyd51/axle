...
CFLAGS = -mno-red-zone -mcmodel=kernel -mno-mmx -mno-sse -mno-sse2 -g -ffreestanding -std=gnu99 -Wall -Wextra -Werror=implicit-function-declaration -I$(SRC_DIR) -I$(SYSROOT)/usr/include
